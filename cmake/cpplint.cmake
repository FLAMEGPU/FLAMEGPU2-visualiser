...
function(flamegpu_visualiser_create_all_lint_target)
    if(CPPLINT_EXECUTABLE AND NOT TARGET all_lint)
        ...
        flamegpu_visualiser_set_target_folder(all_lint "Lint")
    endif()
endfunction()

# Define a function to add a lint target.
function(flamegpu_visualiser_new_linter_target NAME SRC)
    # if cpplint has not been found, do nothing
    if(NOT CPPLINT_EXECUTABLE)
        return()
    endif()
    # Create the all_lint meta target if it does not exist
    flamegpu_visualiser_create_all_lint_target()
