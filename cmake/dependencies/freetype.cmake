...
elseif(WIN32)
    ...
    mark_as_advanced(FORCE CMAKE_DISABLE_FIND_PACKAGE_BZip2)
    mark_as_advanced(FORCE CMAKE_DISABLE_FIND_PACKAGE_PNG)
    ...
    if(TARGET freetype)
        flamegpu_visualiser_disable_compiler_warnings(TARGET freetype)
    endif()
    ...
    mark_as_advanced(FETCHCONTENT_SOURCE_DIR_FREETYPE)
    mark_as_advanced(FETCHCONTENT_UPDATES_DISCONNECTED_FREETYPE)
    mark_as_advanced(CMAKE_DISABLE_FIND_PACKAGE_ZLIB)
    mark_as_advanced(CMAKE_DISABLE_FIND_PACKAGE_HarfBuzz)
    mark_as_advanced(CMAKE_DISABLE_FIND_PACKAGE_BZip2)
    mark_as_advanced(CMAKE_DISABLE_FIND_PACKAGE_PNG)
