#ifndef INCLUDE_FLAMEGPU_VISUALISER_CONFIG_AGENTSTATECONFIG_H_
#define INCLUDE_FLAMEGPU_VISUALISER_CONFIG_AGENTSTATECONFIG_H_
...
#endif  // INCLUDE_FLAMEGPU_VISUALISER_CONFIG_AGENTSTATECONFIG_H_
