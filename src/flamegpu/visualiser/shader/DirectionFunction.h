#ifndef SRC_FLAMEGPU_VISUALISER_SHADER_DIRECTIONFUNCTION_H_
#define SRC_FLAMEGPU_VISUALISER_SHADER_DIRECTIONFUNCTION_H_
...
#endif  // SRC_FLAMEGPU_VISUALISER_SHADER_DIRECTIONFUNCTION_H_
